...
const StatsSection = () => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-white dark:bg-gray-800/50 rounded-xl shadow-sm">
                <div className="text-4xl font-bold text-primary mb-2">{stats.usuariosRegistrados}</div>
            ...
            <div className="text-center p-6 bg-white dark:bg-gray-800/50 rounded-xl shadow-sm">
                <div className="text-4xl font-bold text-accent mb-2">{stats.turnosCompletados}</div>
            ...
            <div className="text-center p-6 bg-white dark:bg-gray-800/50 rounded-xl shadow-sm">
                <div className="text-4xl font-bold text-green-600 mb-2">{stats.odontologosActivos}</div>
            ...
            <div className="text-center p-6 bg-white dark:bg-gray-800/50 rounded-xl shadow-sm">
                <div className="text-4xl font-bold text-blue-600 mb-2">{stats.serviciosDisponibles}</div>
            ...
            <div className="text-center p-6 bg-white dark:bg-gray-800/50 rounded-xl shadow-sm">
                <div className="text-4xl font-bold text-purple-600 mb-2">{stats.turnosReservados}</div>
            ...
            <div className="text-center p-6 bg-white dark:bg-gray-800/50 rounded-xl shadow-sm">
                <div className="text-4xl font-bold text-red-600 mb-2">{stats.turnosHoy}</div>
    ...
    return (
        <div className="relative flex min-h-screen w-full flex-col">
            ...
            <header className="sticky top-0 z-50 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800">
                <div className="container mx-auto flex items-center justify-between whitespace-nowrap px-6 py-4">
                    ...
                    <nav className="hidden md:flex flex-1 justify-center gap-8">
                        <a className="text-sm font-medium hover:text-primary transition-colors" href="#inicio">Inicio</a>
                        <a className="text-sm font-medium hover:text-primary transition-colors" href="#como-funciona">Cómo Funciona</a>
                        <a className="text-sm font-medium hover:text-primary transition-colors" href="#beneficios">Beneficios</a>
                    </nav>
                    <div className="flex gap-2">
                        <Link 
                            to="/login"
                            className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 bg-gray-200 dark:bg-white/10 text-text-light dark:text-text-dark text-sm font-bold leading-normal tracking-[0.015em] hover:bg-gray-300 dark:hover:bg-white/20 transition-colors"
                        >
                            <span className="truncate">Iniciar Sesión</span>
                        </Link>
                        <Link 
                            to="/registro"
                            className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 bg-accent text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-opacity-90 transition-colors"
                        >
            ...
            <main className="flex-grow">
                {/* HeroSection */}
                <section id="inicio" className="py-16 sm:py-24">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div className="flex flex-col gap-6 text-center lg:text-left">
                                ...
                                <div className="flex justify-center lg:justify-start">
                                    <Link 
                                        to="/registro"
                                        className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-6 bg-accent text-white text-base font-bold leading-normal tracking-[0.015em] hover:bg-opacity-90 transition-colors"
                                    >
                                        <span className="truncate">Reservar un Turno Ahora</span>
                                    </Link>
                                </div>
                            </div>
                            <div className="w-full bg-center bg-no-repeat aspect-square sm:aspect-video lg:aspect-square bg-cover rounded-xl" style={{
                ...
                <section id="como-funciona" className="py-16 sm:py-24 bg-white dark:bg-background-dark">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="flex flex-col items-center text-center gap-4 rounded-lg bg-background-light dark:bg-gray-800/50 p-6">
                                <div className="flex items-center justify-center h-16 w-16 rounded-full bg-primary/20 text-primary">
                                    <span className="material-symbols-outlined text-4xl">person_add</span>
                                </div>
                                <div className="flex flex-col gap-1">
                                    <h3 className="text-lg font-bold">Regístrate</h3>
                            ...
                            <div className="flex flex-col items-center text-center gap-4 rounded-lg bg-background-light dark:bg-gray-800/50 p-6">
                                ...
                                <div className="flex flex-col gap-1">
                                    <h3 className="text-lg font-bold">Elige tu Horario</h3>
                            ...
                            <div className="flex flex-col items-center text-center gap-4 rounded-lg bg-background-light dark:bg-gray-800/50 p-6">
                                ...
                                <div className="flex flex-col gap-1">
                                    <h3 className="text-lg font-bold">Asiste a tu Cita</h3>
                ...
                <section id="beneficios" className="py-16 sm:py-24">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div className="flex flex-col gap-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-background-dark p-6">
                                <div className="text-primary"><span className="material-symbols-outlined text-3xl">health_and_safety</span></div>
                                <div className="flex flex-col gap-1">
                                    <h3 className="text-lg font-bold">Atención Profesional</h3>
                            ...
                            <div className="flex flex-col gap-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-background-dark p-6">
                                <div className="text-primary"><span className="material-symbols-outlined text-3xl">schedule</span></div>
                                <div className="flex flex-col gap-1">
                                    <h3 className="text-lg font-bold">Fácil y Rápido</h3>
                            ...
                            <div className="flex flex-col gap-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-background-dark p-6">
                                <div className="text-primary"><span className="material-symbols-outlined text-3xl">groups</span></div>
                                <div className="flex flex-col gap-1">
                                    <h3 className="text-lg font-bold">Servicio Comunitario</h3>
                ...
                <section className="py-16 sm:py-24">
                    <div className="container mx-auto px-6">
                        <div className="bg-primary/90 text-white rounded-xl p-10 md:p-16 text-center">
                            <h2 className="text-3xl font-bold mb-4">¿Listo para empezar a cuidar tu salud dental?</h2>
                            <p className="mb-8 text-lg text-white/80">Regístrate gratis y agenda tu primera cita hoy mismo.</p>
                            <Link 
                                to="/registro"
                                className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-6 bg-accent text-white text-base font-bold leading-normal tracking-[0.015em] hover:bg-opacity-90 transition-colors mx-auto"
                            >
                                <span className="truncate">Únete a Nuestra Comunidad y Sonríe</span>
                            </Link>
                        </div>
                    </div>
                </section>
